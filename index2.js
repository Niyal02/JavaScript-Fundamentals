...
//-------------------------------------------------------------------
//Lexical Scoping
/* It means a child function has access to the variable defined in the parent scope */

const parentFunction =() =>{
    let valueHere = 2;

    function childFunction(){
            console.log(valueHere += 1);
    }
    childFunction();
}
parentFunction();
//-------------------------------------------------------------------
// Closure (Almost same as lexical but here, variable of parent scope can be accessed even after the function is closed)
...
const parentFunc =() =>{
    ...
    return childFunc;        //here instead of calling the child function we return it as the calculation part/value goes to the 'result'
}                            //and as result equals to the parentFunction(which can access to variable i.e 2), which calculates the total value
const result = parentFunc();
console.log(result);
result();                       //everytime we call the result the value is increased by 9
result();
//-------------------------------------------------------------------
//Array methods in react js (most used one is .map() method)
// it allows us to run function in each item in the array and 'key' keyword is addded to improve the performance

const array1 = ['bro', 'homie', 'friend'];

const myList = array1.map((item) => <p>{item}</p>)
console.log(myList);
